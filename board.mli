...
(** [empty_board j] initializes an empty board with a dictionary stored
    in a json file with name j.json.*)
...
(**[get_created_words board word coord dir] is a list of all words
   ...
   [board] at position [coord], [dir] is the direction of the word (true
   for horizontal, false for vertical). Precondition: the placement is
   legal, so all words longer than 1 letter generated by this move are
   valid words, and the move has been played on the board.*)
