...
(** Initializes an empty board with a dictionary stored with a certain json file.*)
val empty_board : Yojson.Basic.t -> t

(** [place_tiles] takes in a board and a move, and returns a pair of the new board
  * and the point value that the move was worth. 
...
val place_tiles : t ->  tiles & their positions(?) -> t*int
